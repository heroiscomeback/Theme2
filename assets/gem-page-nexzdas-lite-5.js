        ...
        jQuery(function() {
            var $module = jQuery('#m-1555584880667').children('.module');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1555584880692').children('.module');
            if(jQuery().gfYoutube) {
                $module.gfYoutube();
            }
        });
        ...
        jQuery(function() {
            var $module = jQuery('#m-1555584880708').children('.module');
            ...
            if(mode == 'dev') {
                var moduleId = "1555584880708";
                var moduleIdSlug = moduleId.toString().replace(/-/g, '');
                if (moduleIdSlug == "1555584880708") {
                    window.getTab1555584880708 = function() {
        ...
        jQuery(function() {
            try {
                var $module = jQuery('#m-1555584880765').children('.module');   
        ...
        jQuery(function() {
            try {
                var $module = jQuery('#m-1555584880761').children('.module');   
                var navspeed = $module.data('navspeed'),
                    autoplaytimeout = $module.data('autoplaytimeout'),
                    autoplayhoverpause = $module.data('autoplayhoverpause'),
                    navlg = $module.data('navlg'),
        ...
        jQuery(function() {
            var $module = jQuery('#m-1555584880836').children('.module');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1555584880731').children('.module');   
            var navspeed = $module.data('navspeed'),
                autoplaytimeout = $module.data('autoplaytimeout'),
                autoplayhoverpause = $module.data('autoplayhoverpause'),
                navlg = $module.data('navlg'),
        ...
        jQuery(function() {
            var $hero = jQuery('#m-1555584880787');
            var $module = jQuery('#m-1555584880787').children('.module');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1555584880806').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1555584880846').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1555584880691').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1555584880796').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1555584880797').children('.module');
            $module.gfV3Product();
        }); 
