        ...
        jQuery(function() {
            var $module = jQuery('#m-1555488814414').children('.module');
            if(jQuery().gfYoutube) {
                $module.gfYoutube();
            }
        });
        ...
        jQuery(function() {
            var $module = jQuery('#m-1555572319387').children('.module');
            ...
            if(mode == 'dev') {
                var moduleId = "1555572319387";
                var moduleIdSlug = moduleId.toString().replace(/-/g, '');
                if (moduleIdSlug == "1555572319387") {
                    window.getTab1555572319387 = function() {
        ...
        jQuery(function() {
            try {
                var $module = jQuery('#m-1555572344351').children('.module');   
        ...
        jQuery(function() {
            try {
                var $module = jQuery('#m-1555574249901').children('.module');   
                var navspeed = $module.data('navspeed'),
                    autoplaytimeout = $module.data('autoplaytimeout'),
                    autoplayhoverpause = $module.data('autoplayhoverpause'),
                    navlg = $module.data('navlg'),
        ...
        jQuery(function() {
            var $module = jQuery('#m-1555472674513').children('.module');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1542855867865').children('.module');
        }); 
        ...
        jQuery(function() {
            var $module = jQuery('#m-1555549250863').children('.module');
            $module.gfV3Product();
        }); 
