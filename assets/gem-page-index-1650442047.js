      ...
      if(cbLink && cbLink != '') {
        ...
        if(target!=="_blank"){
          ...
          window.open(cbLink, '_blank')
                      ...
                      window.__gfFlowActions = []; window.__gfFlowActions.push([]);window.__gfFlowActions.push([]);window.__gfFlowActions.push([]);window.__gfFlowActions.push([]);window.__gfFlowActions.push([]);window.__gfFlowActions.push([]); window.__gfV1FlowActions.init();